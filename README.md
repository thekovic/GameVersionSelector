...
- .NET 10.0 runtime (if you don't have it already, you should get a pop-up when you open `GameVersionSelector.exe` that will offer to install it automatically).
